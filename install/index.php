<?php
    ...
    if ($action == 'result') {
		...
		$response = array('error' => 'ok', 'message' => 'Valid license! CodinganMe');
	...
	<header class="py-3 border-bottom border-primary bg--dark">
		<div class="container">
			<div class="d-flex align-items-center justify-content-between header gap-3">
				...
				<h3 class="title">Easy Installer | <a style="color:red;" href="https://codinganme.com" target="_blank">Licensed By CodinganMe</a></h3>
			</div>
		</div>
	</header>
