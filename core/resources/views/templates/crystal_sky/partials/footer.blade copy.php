                    ...
                    <div class="footer-item">
                        ...
                        <ul class="footer-menu">
                            @foreach ($policyPages as $policy)
                                <li class="footer-menu__item">
                                    <a href="{{ route('policy.pages', ['slug' => transliterator_create('Hex-Any')->transliterate($policy->data_values->title), 'id' => $policy->id]) }}" target="_blank" class="footer-menu__link">{{ __($policy->data_values->title) }}</a>
                                </li>
                            @endforeach
                        </ul>
                    </div>
        ...
        <div class="container">
            <div class="row gy-3 align-items-center">
                ...
                <div class="col-md-6  m-0">
                    <p class="bottom-footer-text text-white"> &copy; @lang('Copyright') © @php echo date('Y') @endphp {{ __($general->site_name) }} @lang('All Right Reserved').
                    </p>
                </div>
            </div>
        </div>
