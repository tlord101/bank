    ...
    @if (@$section->element)
                                ...
                                @if ($k != 'modal')
                                    @if ($type == 'icon')
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <input class="form-control iconPicker icon" name="{{ $k }}"
                                                    data-icon="" type="text" autocomplete="off" required>
                                                <span class="input-group-text input-group-addon" data-icon="las la-home"
                                                    role="iconpicker"></span>
                                            </div>
                                        </div>
        ...
        @push('breadcrumb-plugins')
            <div class="d-flex justify-content-end align-items-center flex-wrap gap-2">
                @if ($section->element->modal)
                    <a class="btn btn-sm btn-outline--primary addBtn" href="javascript:void(0)"><i
                            class="las la-plus"></i>@lang('Add New')</a>
                @else
                    <a class="btn btn-sm btn-outline--primary" href="{{ route('admin.frontend.sections.element', $key) }}"><i
                            class="las la-plus"></i>@lang('Add New')</a>
                @endif
            </div>
        @endpush
