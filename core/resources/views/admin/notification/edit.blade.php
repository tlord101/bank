                        ...
                        <div class="row">
                            <div class="col-md-8">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" name="subject" type="text" value="{{ $template->subj }}"
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input name="email_status" data-height="46px" data-width="100%" data-onstyle="-success"
                                        data-offstyle="-danger" data-bs-toggle="toggle" data-on="@lang('Send Email')"
                                        data-off="@lang("Don't Send")" type="checkbox"
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label>@lang('Status') <span class="text-danger">*</span></label>
                                    <input name="sms_status" data-height="46px" data-width="100%" data-onstyle="-success"
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label>@lang('Status') <span class="text-danger">*</span></label>
                                        <input name="push_notification_status" data-height="46px" data-width="100%"
                                            data-onstyle="-success" data-offstyle="-danger" data-bs-toggle="toggle"
                                            data-on="@lang('Send')" data-off="@lang("Don't Send")" type="checkbox"
